  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[15px] px-[15px] w-full">
        <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1875px] mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-1 flex-col justify-start w-[90%] md:w-full">
              ...
              <div className="flex md:flex-1 flex-col md:gap-10 gap-[86px] justify-start md:mt-0 mt-[46px] w-[24%] md:w-full">
                <div className="flex flex-row items-start justify-between w-full">
                  <Img
                    ...
                    alt="healthcheckup"
                  />
                  <div className="flex flex-col gap-1.5 items-center justify-start mt-3.5">
                    <Text
                ...
                <div className="flex flex-col items-center justify-start md:ml-[0] ml-[63px] rounded-bl-[125px] rounded-br-[125px] shadow-bs1 w-[62%] md:w-full">
                  <Img
                    className="h-[250px] md:h-auto object-cover rounded-bl-[125px] rounded-br-[125px] w-full"
                    src="images/img_istockphoto118_250x246.png"
                    alt="istockphoto118"
                  />
                </div>
              </div>
            ...
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start md:ml-[0] ml-[121px] mt-2.5 w-[64%] md:w-full">
              <Text
                className="md:mt-0 mt-5 md:text-3xl sm:text-[28px] text-[32px] text-gray-900"
                size="txtPoppinsMedium32"
              >
                CT Scan
              </Text>
              <Text
                className="md:ml-[0] ml-[253px] md:mt-0 mt-2.5 text-base text-gray-900_02"
                size="txtPoppinsRegular16"
              >
                Address
              </Text>
              <TextArea
                className="border border-black-900_99 border-solid leading-[normal] md:ml-[0] ml-[202px] pb-[30px] pl-[25px] pr-[35px] pt-2.5 sm:px-5 rounded text-[13px] placeholder:text-black-900_99 text-black-900_99 text-left w-[39%] sm:w-full"
                name="group143"
...
Tamil Nadu`}
            ...
            <Button
              className="common-pointer bg-indigo-900 cursor-pointer font-bold leading-[normal] min-w-[180px] md:ml-[0] ml-[759px] mr-[745px] mt-[110px] py-[9px] rounded text-base text-center text-white-A700"
              onClick={() => navigate("/gdiagnostic")}
            >
              Book Appointment
            </Button>
