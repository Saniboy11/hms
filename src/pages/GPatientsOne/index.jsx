  ...
  const table1Columns = React.useMemo(() => {
    ...
    return [
      ...
      table1ColumnHelper.accessor("id", {
        cell: (info) => (
          <Text
            className="py-[35px] text-base text-blue_gray-700"
            size="txtPoppinsSemiBold16"
          >
            {info?.getValue()}
          </Text>
      ...
      table1ColumnHelper.accessor("emailTwo", {
        cell: (info) => (
          <Text
            className="py-[35px] text-base text-blue_gray-700"
            size="txtPoppinsSemiBold16"
      ...
      table1ColumnHelper.accessor("phonenumber", {
        ...
        header: (info) => (
          <Text
            className="min-w-[210px] py-[9px] text-base text-blue_gray-200 tracking-[0.48px]"
            size="txtPoppinsSemiBold16Bluegray200"
          >
            Phone number
          </Text>
      ...
      table1ColumnHelper.accessor("dateadded", {
        cell: (info) => (
        ...
        header: (info) => (
          <Text
            className="min-w-[193px] pl-1.5 py-[9px] text-base text-blue_gray-200 tracking-[0.48px]"
            size="txtPoppinsSemiBold16Bluegray200"
          >
            Date added
          </Text>
      ...
      table1ColumnHelper.accessor("status", {
        cell: (info) => (
          <div className="flex flex-row items-start justify-between py-[39px]">
            <Button className="bg-gray-100_02 cursor-pointer font-medium leading-[normal] mb-2.5 min-w-[74px] mt-[3px] py-1 rounded-md text-[11px] text-center text-light_green-700">
              In Patient
            </Button>
            <Button className="bg-gray-50 flex h-8 items-center justify-center mb-[7px] p-1.5 rounded-md w-8">
              <Img
                className="h-[19px]"
                alt="arrowright"
                src="info?.getValue()"
      ...
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[15px] px-[15px] w-full">
        <div className="flex md:flex-col flex-row md:gap-12 items-start justify-between max-w-[1879px] mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-1 flex-col justify-start w-[92%] md:w-full">
              ...
              <div className="flex flex-col items-center justify-start pb-3.5 pl-3.5">
                <div className="flex flex-col gap-[33px] items-start justify-start mb-[50px] w-full">
                  <div className="flex flex-row md:gap-10 items-start justify-between w-full">
                    ...
                    <div className="flex flex-col items-center justify-start mb-[21px] p-[3px] w-[15%]">
            ...
            <div className="flex flex-col items-end justify-start md:ml-[0] ml-[11px] w-[89%] md:w-full">
              ...
              <div className="flex flex-row items-center justify-end w-full">
                <GAddPatientAssignDoctorRow className="flex flex-row md:gap-10 items-start justify-between md:pr-10 sm:pr-5 pr-[305px] w-[83%]" />
              </div>
              <GAddPatientAssignDoctorRow
                className="flex md:flex-col flex-row md:gap-5 items-center justify-end mt-[110px] w-[83%] md:w-full"
                userimage="images/img_user_12.svg"
                username="Brooklyn"
                usersurname="Klase"
                userid="87364523"
              ...
              <GAddPatientAssignDoctorRow
                ...
                userimage="images/img_user_13.svg"
              ...
              <GAddPatientAssignDoctorRow
                className="flex md:flex-col flex-row md:gap-5 items-center justify-end mt-[30px] w-[83%] md:w-full"
                userimage="images/img_user_14.svg"
...
export default GPatientsOnePage;
