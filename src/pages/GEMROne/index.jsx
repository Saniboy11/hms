  ...
  return (
    <>
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-poppins sm:gap-10 md:gap-10 gap-[77px] items-start mx-auto pb-[15px] px-[15px] w-full">
        ...
        <div className="h-[1035px] md:h-[3432px] sm:h-[966px] mr-1.5 md:px-5 relative w-[89%] md:w-full">
          ...
          <div className="absolute bottom-[1%] flex md:flex-col flex-row md:gap-10 gap-[88px] items-start justify-center left-[18%] w-[49%]">
            <Img
              className="common-pointer h-[66px] md:mt-0 mt-9 w-[66px]"
              src="images/img_materialsymbol_indigo_900.svg"
              alt="materialsymbol"
              onClick={() => navigate("/gemr")}
            />
            <Img
              className="h-[966px] sm:h-auto object-cover w-[82%] md:w-full"
              src="images/img_16276748201.png"
              alt="16276748201"
            />
          </div>
