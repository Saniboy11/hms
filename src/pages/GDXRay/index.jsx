  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[15px] px-[15px] w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start max-w-[1875px] mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-1 flex-col justify-start md:ml-[0] ml-[71px] md:mt-0 mt-[46px] w-[22%] md:w-full">
            ...
            <div className="flex flex-col h-[250px] items-center justify-start md:ml-[0] ml-[65px] mt-[89px] rounded-[50%] shadow-bs1 w-[250px]">
              <Img
                className="h-[250px] md:h-auto rounded-[50%] w-[250px]"
                src="images/img_29238486080e288_250x250.png"
                alt="29238486080e288"
              />
            </div>
            <Text
              className="md:ml-[0] ml-[139px] mt-8 md:text-3xl sm:text-[28px] text-[32px] text-gray-900"
              size="txtPoppinsMedium32"
            >
              X-Ray
            </Text>
          </div>
          <div className="flex md:flex-1 flex-col justify-start md:ml-[0] ml-[13px] w-[68%] md:w-full">
            ...
            <Text
              className="md:ml-[0] ml-[306px] mt-[114px] text-2xl md:text-[22px] text-gray-900 sm:text-xl"
              size="txtPoppinsMedium24"
            >
              Book Appointment
            </Text>
            <div className="flex flex-col items-start justify-start md:ml-[0] ml-[94px] mt-[59px] w-[54%] md:w-full">
