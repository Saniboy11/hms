...
const GAddPatientBasicInfoAppPage = () => {
  return (
    <>
        ...
        <div className="flex md:flex-col flex-row md:gap-12 items-start justify-between max-w-[1873px] mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-1 flex-col gap-[18px] justify-start w-[92%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
              <div className="flex md:flex-1 flex-col gap-[11px] items-center justify-start md:mt-0 mt-6 w-[15%] md:w-full">
                <Img
              ...
              <div className="flex md:flex-1 flex-col items-start justify-start md:ml-[0] ml-[37px] md:mt-0 mt-[63px] w-[38%] md:w-full">
                <Text
                ...
                <div className="flex flex-row items-start justify-start mt-[3px] w-[47%] md:w-full">
                  <Text
                ...
                <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between mt-12 w-full">
                  <div className="flex sm:flex-1 flex-row items-center justify-between w-[61%] sm:w-full">
                    <div className="h-12 relative w-[55%]">
                      <Line className="absolute bg-light_green-700 bottom-[8%] h-[3px] inset-x-[0] mx-auto w-full" />
                      <Text
                        className="absolute bottom-[10%] inset-x-[0] mx-auto text-light_green-700 text-xl w-max"
                    ...
                    <div className="flex flex-row items-end justify-evenly w-[31%]">
                      ...
                      <Text
                        className="mb-1 mt-[13px] text-black-900_87 text-xl"
                  ...
                  <div className="flex sm:flex-1 flex-row items-end justify-evenly w-[26%] sm:w-full">
                    <Text
                      className="md:text-3xl sm:text-[28px] text-[32px] text-black-900_87"
                      size="txtPoppinsSemiBold32"
                    >
                    ...
                    <Text
                      className="mb-0.5 mt-[15px] text-black-900_87 text-xl"
                      size="txtPoppinsSemiBold20"
                    >
                      Assign Doctor
                    </Text>
              ...
              <div className="flex md:flex-1 flex-col items-center justify-start md:ml-[0] ml-[559px] p-[3px] w-[13%] md:w-full">
            ...
            <div className="flex flex-col items-start justify-start md:ml-[0] ml-[47px] w-[77%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start mt-4 w-[73%] md:w-full">
                <Text
                  className="text-base text-gray-900_02"
                  size="txtPoppinsRegular16"
                >
                ...
                <Text
                  className="md:ml-[0] ml-[325px] text-base text-gray-900_02"
                  size="txtPoppinsRegular16"
                >
                  Email Address
                </Text>
                <Text
                  className="md:ml-[0] ml-[329px] text-base text-gray-900_02"
                  size="txtPoppinsRegular16"
                >
                  Mobile
                </Text>
              </div>
              <div className="gap-7 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 items-center justify-between mt-[5px] w-full">
                <Input
                  name="group418"
              ...
              <Button className="bg-indigo-900 cursor-pointer font-bold leading-[normal] min-w-[110px] md:ml-[0] ml-[594px] mt-[70px] py-[11px] rounded text-[13px] text-center text-white-A700">
                NEXT STEP
              </Button>
            </div>
          </div>
...
export default GAddPatientBasicInfoAppPage;
