      ...
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[15px] px-[15px] w-full">
        <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1876px] mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-1 flex-col justify-start w-[90%] md:w-full">
            <div className="flex md:flex-col flex-row gap-[13px] items-end justify-between w-full">
              <div className="flex md:flex-1 flex-col md:gap-10 gap-[86px] justify-start md:mt-0 mt-[46px] w-[24%] md:w-full">
                <div className="flex flex-row items-start justify-between w-full">
                  <Img
                    className="h-[198px] md:h-auto object-cover w-[198px]"
                    src="images/img_healthcheckup.png"
                    alt="healthcheckup"
                  />
                  <div className="flex flex-col gap-[5px] items-start justify-start mt-[15px]">
                    <Text
                ...
                <div className="flex flex-col h-[250px] items-center justify-start md:ml-[0] ml-[63px] rounded-[50%] shadow-bs1 w-[250px]">
                  <Img
                    className="h-[250px] md:h-auto rounded-[50%] w-[250px]"
                    src="images/img_istockphoto124_250x250.png"
                    alt="istockphoto124"
                  />
                </div>
              </div>
              <div className="flex md:flex-1 flex-col justify-start w-[76%] md:w-full">
                ...
                <Text
                  className="md:ml-[0] ml-[306px] mt-[116px] text-2xl md:text-[22px] text-gray-900 sm:text-xl"
                  size="txtPoppinsMedium24"
                >
                  Book Appointment
                </Text>
                <div className="flex flex-col gap-[11px] items-center justify-start md:ml-[0] ml-[94px] mt-10 w-[54%] md:w-full">
            ...
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start md:ml-[0] ml-[130px] mt-2.5 w-[63%] md:w-full">
              <Text
                className="md:mt-0 mt-[21px] md:text-3xl sm:text-[28px] text-[32px] text-gray-900"
                size="txtPoppinsMedium32"
              >
                BP Test
              </Text>
              <Text
                className="md:ml-[0] ml-[262px] md:mt-0 mt-2.5 text-base text-gray-900_02"
                size="txtPoppinsRegular16"
              >
                Address
              </Text>
              <TextArea
                className="border border-black-900_99 border-solid leading-[normal] md:ml-[0] ml-[202px] pb-[30px] pl-[25px] pr-[35px] pt-2.5 sm:px-5 rounded text-[13px] placeholder:text-black-900_99 text-black-900_99 text-left w-2/5 sm:w-full"
                name="group106"
...
Tamil Nadu`}
            ...
            <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start md:ml-[0] ml-[507px] mt-[11px] w-[32%] md:w-full">
              <Text
                className="text-base text-gray-900_02"
                size="txtPoppinsRegular16"
              >
            ...
            <Button
              className="common-pointer bg-indigo-900 cursor-pointer font-bold leading-[normal] min-w-[180px] md:ml-[0] ml-[759px] mr-[746px] mt-[110px] py-[9px] rounded text-base text-center text-white-A700"
              onClick={() => navigate("/gdiagnostic")}
            >
              Book Appointment
            </Button>
