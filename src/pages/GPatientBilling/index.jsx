    ...
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[15px] px-[15px] w-full">
        <div className="flex md:flex-col flex-row md:gap-[47px] items-start justify-between max-w-[1875px] mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-1 flex-col gap-[34px] justify-start w-[92%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
              <Img
                ...
                alt="calculating"
              />
              <div className="flex md:flex-1 flex-col gap-[5px] items-start justify-start md:ml-[0] ml-[38px] md:mt-0 mt-[59px] w-[15%] md:w-full">
                <Text
              ...
              <div className="flex md:flex-1 flex-col items-center justify-start md:ml-[0] ml-[961px] p-[3px] w-[13%] md:w-full">
            ...
            <div className="flex flex-col gap-[7px] items-start justify-start ml-3 md:ml-[0] w-[93%] md:w-full">
              <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between w-[66%] md:w-full">
                <Button
                  className="common-pointer border-[3px] border-indigo-900 border-solid cursor-pointer font-semibold leading-[normal] min-w-[230px] sm:mt-0 mt-[9px] py-2.5 rounded-[5px] text-center text-indigo-900 text-xl"
                  onClick={() => navigate("/gbilldetails")}
                >
                  Staff Payroll
                </Button>
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
                ...
                <div className="flex md:flex-1 flex-col md:gap-10 gap-[129px] justify-start md:mt-0 mt-[33px] w-4/5 md:w-full">
                  <div className="sm:h-[3160px] h-[399px] relative w-full">
                    <div className="sm:h-[3160px] md:h-[388px] h-[399px] m-auto w-full">
                      <div className="absolute bg-blue_gray-100_3f border border-blue-100 border-solid flex flex-col h-max inset-[0] items-center justify-center m-auto p-[38px] sm:px-5 rounded-tl-[10px] rounded-tr-[10px] w-full">
                        <List
                          className="flex flex-col gap-[9px] items-center mt-6 w-[98%]"
                          orientation="vertical"
                        >
                          <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start w-full">
                            ...
                            <Text
                              className="sm:ml-[0] ml-[91px] text-base text-black-900"
                              size="txtPoppinsRegular16Black900"
                            >
                              Warehe
                            </Text>
                            <Text
                              className="sm:ml-[0] ml-[85px] text-base text-black-900"
                              size="txtPoppinsRegular16Black900"
                            >
                              2128286
                            </Text>
                            <Text
                              className="sm:ml-[0] ml-[109px] text-base text-black-900"
                              size="txtPoppinsRegular16Black900"
                            >
                              600.00
                            </Text>
                            ...
                            <Text
                              className="sm:ml-[0] ml-[103px] text-base text-black-900"
                              size="txtPoppinsRegular16Black900"
                            >
                              4000.00
                            </Text>
                      ...
                      <div className="absolute bg-blue-100 border border-blue-100 border-solid flex sm:flex-col flex-row sm:gap-5 inset-x-[0] items-start justify-start mx-auto p-1.5 rounded-tl-[10px] rounded-tr-[10px] top-[0] w-full">
                        <Text
                          className="mb-2 sm:ml-[0] ml-[15px] text-black-900 text-lg"
                          size="txtPoppinsRegular18"
                        >
                          Sl No.
                        </Text>
                        <Text
                          className="mb-2 sm:ml-[0] ml-[39px] text-black-900 text-lg"
                          size="txtPoppinsRegular18"
                        >
                          Patient Name
                        </Text>
                        <Text
                          className="mb-[7px] ml-11 sm:ml-[0] text-black-900 text-lg"
                          size="txtPoppinsRegular18"
                        >
                          Patient ID
                        </Text>
                        <Text
                          className="mb-[9px] sm:ml-[0] ml-[57px] text-black-900 text-lg"
                          size="txtPoppinsRegular18"
                        >
                          Consultant Fee
                        </Text>
                        <Text
                          className="mb-[9px] sm:ml-[0] ml-[62px] text-black-900 text-lg"
                          size="txtPoppinsRegular18"
                        >
                          Medical Expenses{" "}
                        </Text>
                        <Text
                          className="mb-1.5 sm:ml-[0] ml-[54px] sm:mt-0 mt-0.5 text-black-900 text-lg"
                          size="txtPoppinsRegular18"
                        >
                          Lab Charge
                        </Text>
                        ...
                        <Text
                          className="mb-[9px] sm:ml-[0] ml-[27px] text-black-900 text-lg"
                          size="txtPoppinsRegular18"
                        >
                          Remarks
                        </Text>
                    ...
                    <Line className="absolute bg-blue-100 h-[399px] inset-y-[0] left-[20%] my-auto w-px" />
                    <Line className="absolute bg-blue-100 h-[399px] inset-y-[0] left-[31%] my-auto w-px" />
                    <Line className="absolute bg-blue-100 h-[399px] inset-y-[0] left-[48%] my-auto w-px" />
                    <Line className="absolute bg-blue-100 h-[399px] inset-y-[0] my-auto right-[36%] w-px" />
                    <Line className="absolute bg-blue-100 h-[399px] inset-y-[0] my-auto right-[22%] w-px" />
...
export default GPatientBillingPage;
