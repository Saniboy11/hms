...
const GAddPatientBasicInfoPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[15px] px-[15px] w-full">
        <div className="flex md:flex-col flex-row md:gap-12 items-start justify-between max-w-[1874px] mx-auto md:px-5 w-full">
          <List
          ...
          <div className="flex md:flex-1 flex-col gap-[18px] justify-start w-[92%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
              ...
              <div className="flex md:flex-1 flex-col items-start justify-start md:ml-[0] ml-[37px] md:mt-0 mt-[59px] w-[23%] md:w-full">
                <Text
                ...
                <div className="flex flex-row items-center justify-between mt-[51px] w-full">
                  ...
                  <div
                    className="common-pointer flex flex-row items-end justify-evenly w-[31%]"
                    onClick={() => navigate("/gaddpatientproblems")}
                  >
                    <Text
              ...
              <div className="flex md:flex-1 flex-col items-center justify-start md:ml-[0] ml-[814px] p-[3px] w-[13%] md:w-full">
            ...
            <div className="flex flex-col items-start justify-start md:ml-[0] ml-[47px] w-[77%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-3/4 md:w-full">
                ...
                <Text
                  className="mb-0.5 md:ml-[0] ml-[343px] text-base text-gray-900_02"
                  size="txtPoppinsRegular16"
                >
                  First Name
                </Text>
              ...
              <div className="gap-7 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 items-center justify-between mt-[3px] w-full">
                <Input
                  ...
                  suffix={
                    <div className="h-[13px] mt-px mb-1.5 ml-[35px] w-[13] bg-black-900_87">
                      <Img
...
export default GAddPatientBasicInfoPage;
