          ...
          <div className="flex md:flex-1 flex-col justify-start w-[90%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
              <Img
                ...
                alt="healthcheckup"
              />
              <div className="flex md:flex-1 flex-col items-start justify-start md:ml-[0] ml-[70px] md:mt-0 mt-[60px] w-[15%] md:w-full">
                <Text
              ...
              <div className="flex md:flex-1 flex-col items-center justify-start md:ml-[0] ml-[967px] p-[3px] w-[13%] md:w-full">
            ...
            <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between md:ml-[0] ml-[63px] mt-[9px] w-[67%] md:w-full">
              <div className="flex flex-col h-[250px] items-center justify-start md:mt-0 mt-[76px] rounded-[50%] shadow-bs1 w-[250px]">
                <Img
                  ...
                  src="images/img_360f328481670_250x250.png"
                  alt="360f328481670"
                />
              </div>
            ...
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start md:ml-[0] ml-[97px] mt-2.5 w-[65%] md:w-full">
              <Text
              ...
              <Text
                className="md:ml-[0] ml-[229px] md:mt-0 mt-2.5 text-base text-gray-900_02"
                size="txtPoppinsRegular16"
              >
                Address
              </Text>
              <TextArea
                className="border border-black-900_99 border-solid leading-[normal] md:ml-[0] ml-[202px] pb-[30px] pl-[25px] pr-[35px] pt-2.5 sm:px-5 rounded text-[13px] placeholder:text-black-900_99 text-black-900_99 text-left w-[38%] sm:w-full"
                name="group167"
...
export default GDRenalScanPage;
