...
const GAddPatientProblemsAppPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[15px] px-[15px] w-full">
        <div className="flex md:flex-col flex-row md:gap-12 items-start justify-between max-w-[1877px] mx-auto md:px-5 w-full">
          <List
            ...
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
              ...
              <div className="flex md:flex-1 flex-col items-start justify-start md:ml-[0] ml-[37px] md:mt-0 mt-[63px] w-[38%] md:w-full">
                ...
                <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between mt-12 w-full">
                  <div className="flex sm:flex-1 flex-row items-center justify-between w-[66%] sm:w-full">
                    ...
                    <div
                      className="common-pointer h-12 relative w-[36%]"
              ...
              <div className="flex md:flex-1 flex-col items-center justify-start md:ml-[0] ml-[563px] p-[3px] w-[13%] md:w-full">
...
export default GAddPatientProblemsAppPage;
