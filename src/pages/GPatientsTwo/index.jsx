...
const GPatientsTwoPage = () => {
  ...
  const tableColumns = React.useMemo(() => {
    ...
    return [
      ...
      tableColumnHelper.accessor("emailTwo", {
        cell: (info) => (
          <Text
              ...
              <div className="flex flex-col items-center justify-start pb-3.5 pl-3.5">
                <div className="flex flex-col gap-[33px] items-start justify-start mb-[50px] w-full">
                  <div className="flex flex-row md:gap-10 items-start justify-between w-full">
                    ...
                    <div className="flex flex-col items-center justify-start mb-5 p-[3px] w-[15%]">
                  ...
                  <div className="flex flex-row md:gap-10 items-center justify-between max-w-[1241px] md:ml-[0] ml-[5px] w-full">
                    ...
                    <div className="flex flex-col items-center justify-start w-[14%]">
                      <Button
                        className="bg-indigo-900 cursor-pointer flex items-center justify-center min-w-[168px] px-5 py-2.5 rounded-md"
                        leftIcon={
                          <Img
                            className="h-5 mr-2"
            ...
            <div className="flex flex-col items-end justify-start md:ml-[0] ml-[11px] w-[89%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row gap-9 items-start justify-between mt-[3px] w-full">
                ...
                <GAddPatientAssignDoctorRow
                  ...
                  userimage="images/img_user_4.svg"
              ...
              <GAddPatientAssignDoctorRow
                ...
                userimage="images/img_user_5.svg"
              ...
              <GAddPatientAssignDoctorRow
                className="flex md:flex-col flex-row md:gap-5 items-center justify-end mt-[30px] w-[83%] md:w-full"
                userimage="images/img_user_6.svg"
                username="Brooklyn"
                usersurname="Klase"
                userid="87364523"
              ...
              <GAddPatientAssignDoctorRow
                className="flex md:flex-col flex-row md:gap-5 items-center justify-end mt-[30px] w-[83%] md:w-full"
                userimage="images/img_user_7.svg"
              ...
              <GAddPatientAssignDoctorRow
                className="flex md:flex-col flex-row md:gap-5 items-center justify-end mt-[30px] w-[83%] md:w-full"
                userimage="images/img_user_8.svg"
                username="Jacob Jones"
                usersurname="Mawa"
                userid="23847569"
                useremail="jacbj@mail.com"
              ...
              <GAddPatientAssignDoctorRow
                className="flex md:flex-col flex-row md:gap-5 items-center justify-end mt-[30px] w-[83%] md:w-full"
                userimage="images/img_user_9.svg"
                username="Cody Fisher"
                usersurname="yuros"
                userid="39485632"
                useremail="codyf@mail.com"
...
export default GPatientsTwoPage;
