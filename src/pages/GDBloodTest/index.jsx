...
const GDBloodTestPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[15px] px-[15px] w-full">
        <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between max-w-[1871px] mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-1 flex-col justify-start w-[90%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
              <Img
                ...
                alt="healthcheckup"
              />
              <div className="flex md:flex-1 flex-col items-start justify-start md:ml-[0] ml-[70px] md:mt-0 mt-[60px] w-[14%] md:w-full">
                <Text
                ...
                <div className="flex flex-row gap-[13px] items-start justify-between mt-1 w-full">
                  <Text
              ...
              <div className="flex md:flex-1 flex-col items-center justify-start md:ml-[0] ml-[970px] p-[3px] w-[13%] md:w-full">
            ...
            <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between md:ml-[0] ml-[65px] mt-[9px] w-[67%] md:w-full">
              <div className="flex flex-col h-[250px] items-center justify-start md:mt-0 mt-[76px] rounded-[50%] shadow-bs1 w-[250px]">
                <Img
                  ...
                  src="images/img_handsholdingm_250x250.png"
                  alt="handsholdingm"
                />
              </div>
              <div className="flex flex-col gap-[59px] justify-start w-[61%] md:w-full">
                <Text
            ...
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start md:ml-[0] ml-[107px] mt-2.5 w-[65%] md:w-full">
              <Text
                className="md:text-3xl sm:text-[28px] text-[32px] text-gray-900"
                size="txtPoppinsMedium32"
              >
              ...
              <Text
                className="md:ml-[0] ml-[233px] md:mt-0 mt-[9px] text-base text-gray-900_02"
                size="txtPoppinsRegular16"
              >
                Mobile
              </Text>
              <Input
                ...
                className="leading-[normal] p-0 placeholder:text-black-900_99 sm:px-5 text-[13px] text-black-900_99 text-left w-full"
                wrapClassName="border border-black-900_99 border-solid md:ml-[0] ml-[215px] pl-[25px] pr-[35px] py-2.5 rounded w-[39%] md:w-full"
              ></Input>
            </div>
            <div className="flex flex-col items-start justify-start md:ml-[0] ml-[507px] mt-0.5 w-[41%] md:w-full">
              <div className="flex sm:flex-col flex-row sm:gap-10 items-start justify-between w-full">
                ...
                <TextArea
                  className="border border-black-900_99 border-solid leading-[normal] pb-[30px] pl-[25px] pr-[35px] pt-2.5 sm:px-5 rounded text-[13px] placeholder:text-black-900_99 text-black-900_99 text-left"
                  name="group427"
...
Tamil Nadu`}
              ...
              <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start mt-[11px] w-4/5 md:w-full">
                <Text
                  className="text-base text-gray-900_02"
                  size="txtPoppinsRegular16"
                >
              ...
              <Button
                className="common-pointer bg-indigo-900 cursor-pointer font-bold leading-[normal] min-w-[180px] md:ml-[0] ml-[252px] mt-[90px] py-[9px] rounded text-base text-center text-white-A700"
                onClick={() => navigate("/gdiagnostic")}
              >
                Book Appointment
              </Button>
...
export default GDBloodTestPage;
