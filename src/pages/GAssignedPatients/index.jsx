...
const GAssignedPatientsPage = () => {
  const table3Data = React.useRef([
    {
      name: "Klase",
      id: "87364523",
      emailTwo: "brooklyns@mail.com",
  ...
  const table3Columns = React.useMemo(() => {
    ...
    return [
      ...
      table3ColumnHelper.accessor("emailTwo", {
        cell: (info) => (
          <Text
      ...
      table3ColumnHelper.accessor("dateadded", {
        cell: (info) => (
      ...
      table3ColumnHelper.accessor("status", {
        cell: (info) => (
          <div className="flex flex-row items-start justify-between py-[9px]">
            <Button className="bg-gray-100_02 cursor-pointer font-medium leading-[normal] mb-[3px] min-w-[74px] mt-[33px] py-1 rounded-md text-[11px] text-center text-light_green-700">
              In Patient
            </Button>
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[15px] px-[15px] w-full">
        <div className="flex md:flex-col flex-row md:gap-[59px] items-start justify-between max-w-[1875px] mx-auto md:px-5 w-full">
          <List
          ...
          <div className="flex md:flex-1 flex-col justify-start w-[91%] md:w-full">
            <div className="flex md:flex-col flex-row gap-[25px] items-start justify-between md:ml-[0] ml-[9px] w-full">
              ...
              <div className="flex flex-col items-center justify-start pb-3.5 pl-3.5">
                <div className="flex flex-col gap-[30px] items-start justify-start mb-[50px] w-full">
                  <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between w-full">
                    <div className="flex sm:flex-1 flex-col items-start justify-start sm:mt-0 mt-16 w-[21%] sm:w-full">
                      <Text
                      ...
                      <div className="flex flex-row items-start justify-start w-[87%] md:w-full">
                        ...
                        <Img
                          className="h-[19px] ml-2 mt-0.5"
                          src="images/img_forward.svg"
                          alt="forward"
                        />
                        <Text
                          className="ml-2.5 text-base text-gray-900_87"
                          size="txtPoppinsMedium16"
                        >
                          Assigned Patients
                        </Text>
                    ...
                    <div className="flex sm:flex-1 flex-col items-center justify-start mb-[23px] p-[3px] w-[16%] sm:w-full">
                  ...
                  <div className="flex flex-col items-center justify-between max-w-[1241px] md:ml-[0] ml-[5px] md:pr-10 sm:pr-5 pr-[1091px] w-full">
            ...
            <div className="flex flex-col items-end justify-start w-[89%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row gap-9 items-start justify-between mt-[3px] w-full">
                <Button className="border-[3px] border-indigo-900 border-solid cursor-pointer font-semibold leading-[normal] mb-[27px] min-w-[230px] py-2.5 rounded-[5px] text-center text-indigo-900 text-xl">
                  Out Patient
                </Button>
                <GAddPatientAssignDoctorRow
                  className="flex md:flex-col flex-row md:gap-5 items-center justify-start md:mt-0 mt-[27px]"
                  userimage="images/img_user_20.svg"
                  ...
                  userdate="23/12/2022"
                  usertime="12:40 PM"
                  userlabel="In Patient"
                  usericon="images/img_arrowright.svg"
                />
              </div>
              <GAddPatientAssignDoctorRow
                className="flex md:flex-col flex-row md:gap-5 items-center justify-end mt-[30px] w-[83%] md:w-full"
                userimage="images/img_user_21.svg"
              ...
              <GAddPatientAssignDoctorRow
                className="flex md:flex-col flex-row md:gap-5 items-center justify-end mt-[30px] w-[83%] md:w-full"
                userimage="images/img_user_22.svg"
                username="Brooklyn"
                usersurname="Klase"
                userid="87364523"
              ...
              />
              <div
                className="common-pointer bg-cover bg-no-repeat flex flex-col h-[43px] items-center justify-end mt-[292px] p-[9px] w-[8%] md:w-full"
...
export default GAssignedPatientsPage;
