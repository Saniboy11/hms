...
const GDoctorOnePage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-center justify-start mx-auto pb-[15px] px-[15px] w-full">
        <div className="flex md:flex-col flex-row md:gap-[59px] items-start justify-between max-w-[1877px] mx-auto md:px-5 w-full">
          <List
          ...
          <div className="flex md:flex-1 flex-col gap-[30px] justify-start w-[91%] md:w-full">
            <div className="flex md:flex-col flex-row gap-[25px] items-start justify-between md:ml-[0] ml-[9px] w-full">
              ...
              <div className="flex flex-col gap-[22px] justify-start">
                ...
                <div className="bg-gray-50 flex md:flex-col flex-row md:gap-5 items-start justify-start mr-48 p-2 rounded-md w-[87%] md:w-full">
                  <Text
            ...
            <div className="flex flex-col items-end justify-start w-[89%] md:w-full">
              <div className="flex sm:flex-col flex-row gap-9 items-start justify-between w-full">
                <Button
                  className="common-pointer border-[3px] border-indigo-900 border-solid cursor-pointer font-semibold leading-[normal] min-w-[230px] sm:mt-0 mt-[13px] py-2.5 rounded-[5px] text-center text-indigo-900 text-xl"
              ...
              <div className="flex sm:flex-col flex-row gap-9 items-start justify-between mt-2.5 w-full">
                <Button className="bg-indigo-900 cursor-pointer font-semibold leading-[normal] mb-[7px] min-w-[230px] py-2.5 rounded-br-[50px] text-center text-white-A700 text-xl">
                  Duty Doctors
                </Button>
                <Button
